...
function renderLayout(title, description, content, activePage, storeMap, availableStoreIDs, deals) {
    ...
    // --- THE NEW NEWSLETTER CAPTURE UI ---
    const newsletterSection = `
    <div class="max-w-7xl mx-auto px-6 py-16">
        <div class="bg-gradient-to-r from-indigo-900/60 to-purple-900/60 border border-indigo-500/30 rounded-3xl p-10 md:p-16 text-center shadow-2xl relative overflow-hidden">
            <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,')]"></div>
            <div class="relative z-10 max-w-2xl mx-auto">
                ...
                <p class="text-slate-500 text-xs mt-4">100% Free. Zero spam. Unsubscribe anytime.</p>
            </div>
        </div>
    </div>`;
    ...
    <body class="text-slate-200 antialiased flex flex-col min-h-screen mesh-gradient">
        ...
        <main class="flex-grow pt-40 pb-10">
            ${content}
            ${newsletterSection}
        </main>
